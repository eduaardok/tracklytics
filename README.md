...
| S12 | Reportes administrativos de `seguridad` | 2 endpoints de solo lectura: `GET /admin/usuarios-reporte` (listado de usuarios enriquecido con rol administrativo, canal de adquisición y plan activo) y `GET /admin/strikes` (strikes activos globales, panel de moderación transversal) — ver `docs/BITACORA_S12.md` |
