...
# (14 días) y un tope de 366 días (FACT_TRANSACCION_PAGO crece sin límite,
# un rango sin tope arriesga un full scan).
...
def dashboard_facturacion(
    ...
    return {
        "ingreso_por_dia":         query_rows(INGRESO_POR_DIA, {"desde": rango_desde, "hasta": rango_hasta}),
