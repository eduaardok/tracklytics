...
- Confirmación automática de la titularidad del email institucional por correo (ej. un enlace que el usuario deba abrir desde esa casilla); la elegibilidad de checkout del plan estudiante sigue siendo una verificación de formato de punto de venta. La evidencia real (comprobante + revisión de un `admin_comercial`) sí existe como canal aparte — ver "Comprobante de estudiante con revisión administrativa".
