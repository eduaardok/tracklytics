...
- [x] 1.1 Crear colección `suscripciones` (usuario_o_cliente, tipo_plan, monto, moneda, estado, created — `created` como campo autodate cubre la fecha de inicio, RF-SUS-003) con regla de acceso: solo el propietario puede leer/crear su suscripción
