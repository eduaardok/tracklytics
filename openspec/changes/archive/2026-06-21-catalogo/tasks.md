...
- [x] 2.5 Verificar que un login con credenciales inválidas responde con un mensaje de error genérico (el devuelto por PocketBase) sin indicar el campo que falló (Escenario 2)
...
- [x] 5.3 Mostrar mensaje de error genérico en login fallido sin indicar el campo (Escenario 2)
