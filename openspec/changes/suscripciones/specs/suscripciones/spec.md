...
- **PocketBase o ClickHouse** (FACT_SUSCRIPCION, DIM_PLAN_SUSCRIPCION, DIM_CLIENTE) para persistencia — a confirmar en design.md cuál motor aloja esta entidad operativa.
