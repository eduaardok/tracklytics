...
- **PocketBase**: nuevas colecciones/registros para autenticación de usuarios, favoritos, playlists (y sus tracks) e historial de reproducción, con reglas de acceso por usuario.
- **ClickHouse**: lectura de FACT_TRACKS, DIM_ARTISTS, DIM_ALBUMS, DIM_GENRES (sin escritura desde esta capability).
